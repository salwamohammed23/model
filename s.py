...
import cv2 import os import requests
...
if uploaded_file is not None: tab1, tab2 = st.tabs(["Skin_canser Detection", "webcam"]) out_img, out_name = predict_with_yolov8(uploaded_file)
